...
def generate_diff_(file_path1, file_path2):
    ...
    abs_path1 = os.path.join(os.getcwd(), file_path1)
    abs_path2 = os.path.join(os.getcwd(), file_path2)

    with open(abs_path1) as file1, open(abs_path2) as file2:
    ...
    return flatt_differ(data1, data2)


def flatt_differ(data1, data2):
    result = '{\n'
